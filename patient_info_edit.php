...
<img id="p_img" src="img\logo_f.png"  ALIGN="center"> <p id="doc_name">&nbsp;&nbsp;Dr. <?php echo $users['fname'];  ?></p>
  <a class="home_b" href="physician_home.php">Home</a><a class="logout_b"  href="logout.php">Logout</a>
   ...
   <div class="myBox_add_patient" style="width: 70%; height: 67vh;margin-left: 15%;background-color: #e6f2ff;font-size: 20px;"> 
    <form action="patient_info_edit_in.php" method="post">
      ...
      <div>
        <span id="p_span_info2">
            <input id="info_edit_form"  type="text" name="r_name" value="<?= !empty($r_name) ? $r_name : '' ?>" placeholder="Condition" required>
            
        </span>
        <span id="p_span_info2" style="margin-left: 9.5%;">
            
            <input id="info_edit_form"  type="number" name="r_num" value="<?= !empty($r_num) ? $r_num : '' ?>" placeholder="Phone Number" required>
        </span>
      </div>
<div>
        <span id="p_span_info">
