...
var redirectUrl =
    'com.googleusercontent.apps.292002520319-8aqrl9ru6tijeqeuhruqfbujan4d5jre:/oauth2redirect'; // redirectURl in the case of mobile app is the clientID inverted + :/oauth2redirect
var id;
...
Future<void> getToken(var text) async {
  ...
  final http.Response httpResponse = await http.post(
      Uri.parse(
          'https://global-dialogflow.googleapis.com/v3/projects/bionic-flux-342309/locations/global/agents/f60ed910-e418-4d61-9095-785d300a3972/sessions/$session_id:detectIntent'),
