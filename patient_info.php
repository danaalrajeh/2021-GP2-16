...
<body style="background-color: #ffffff;margin-top: 0;margin-bottom: 0;">
   ...
   <div class="myBox_add_patient" style="width: 70%; height: 80vh;margin-left: 15%;background-color: #e6f2ff;font-size: 20px;"> 
        ...
        <span id="p_span_info">
          <p style="padding-left: 40%;"><strong>Birthday : </strong><?php echo $patient['birthday']; ?></p>
        </span>
        <span id="p_span_info">
      ...
      <div>
        ...
        <span id="p_span_info1">
          <p style="padding-left: 20%;"><strong>Email : </strong><?php echo$patient['email']; ?></p>
        </span>

        </div>
        <div>
        <span id="p_span_info1">
          <p style="padding-left: 6%;"><strong>Password : </strong><?php echo"********"; ?></p>
        </span>
      ...
      <div>
        ...
        <span id="p_span">
          <p style="padding-left: 4%;"><strong>Phone Number : </strong><?php echo $patient['phone']; ?></p>
        </span>
      </div>
      <div>
        <span id="p_span">
          <p style="padding-left: 10%;"><strong>Relative Name : </strong><?php echo  $patient['relative_name']; ?></p>
        </span>
        <span id="p_span">
          <p style="padding-left: 4%;"><strong>Relative Phone Number : </strong><?php echo  $patient['relative_phone']; ?></p>
        </span>
      </div><br>
      <div>
        <span id="p_span_info">
