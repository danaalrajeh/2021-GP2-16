  ...
  <a class="home_b" href="physician_home.php">Home</a><a class="logout_b"  href="logout.php">Logout</a>
   ...
   <div class="myBox" style="width: 70%; height: 70vh; margin-left: 15%;background-color:  #e6f2ff;font-size: 20px;">
    ...
    if ($stmt->rowCount()>0) {
      ...
      echo '<label style="color:#191970;margin-left:2%"> &nbsp;&nbsp;&nbsp;&nbsp;Activity type :</label><input id="med_form"  type="text" name="m_name" value="'.$atype.'" placeholder="Activity Type" readonly><br><br><label style="color:#191970;margin-left:2%" >Activity Duration :</label><input id="med_form"  type="text" name="m_name" value="'.$aduration.'" placeholder="Duration" readonly><br><br><label style="color:#191970;margin-left:2%">Activity Description :</label><textarea id="med_textarea" style="margin-left: 1.5%;" name="" rows="3" cols="80" placeholder="Add Description of physical activity . . ." readonly>'.$aexp.'</textarea>';  
    }
    
   else{
    echo '<form action="edit_activity_in.php" method="post">
        <input type="hidden" name="p_id" value="'.$p_id.'">
        <label class="required" style="color:#191970;margin-left:2%">Activity type :</label><input id="med_form"  type="text" name="atype"  placeholder="Activity Type" required><br><br><label class="required" style="color:#191970;margin-left:2%">Activity Duration :</label><input id="med_form"  type="text" name="aduration"  placeholder="Duration" required><br><br><label class="required" style="color:#191970;margin-left:2%">Activity Description :</label>
         <textarea id="med_textarea" name="act" rows="3" cols="75" placeholder="Add Description of physical activity . . ." required></textarea>
        <button id="p_b" type="submit" >Add Activity</button>
        </form> ';
   }
