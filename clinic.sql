...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2022 at 09:40 PM
...
INSERT INTO `alarm` (`id`, `p_id`, `symptom`, `relative_name`, `phone`) VALUES
(5, 11, 'test', 'test', 123);
...
(1, 'بانادول', 'نستشيالاشسنتينشسايتنشسيا'),
(2, 'كونجستال', 'لاةىرلاىرىرىرتى'),
(3, 'jjj', 'sadasd');
...
INSERT INTO `patients` (`id`, `fname`, `birthday`, `cond`, `username`, `password`, `phone`, `physician_id`) VALUES
(2, 'test test test', '2021-10-15', 'testttttt', '', '', 0, 2),
(3, 'test1 test1 test1', '2021-07-14', 'test test', '', '', 0, 2),
(5, 'rt', '2021-10-13', 'testttttt', '', '', 0, 2),
(6, 'test test', '2021-10-13', 'ttttttttttttttttttttttt', '', '', 0, 1),
(8, 'farah farah', '2021-11-16', 'asdsadas', '', '', 0, 1),
(9, 'first patient', '2021-11-11', 'condition', '', '', 0, 1),
(10, 'second patient', '2021-11-28', 'condition', '', '', 0, 1),
(11, '1th patient', '2021-11-16', 'condition', 'first.paitent', '202cb962ac59075b964b07152d234b70', 1234, 7),
(14, 'bhbn jhvbmb', '2022-01-24', 'ada', 'adad', '523af537946b79c4f8369ed39ba78605', 515, 10),
(15, 'dod', '2022-02-08', 'cond', 'dod', '75a2c1a1abd1a7dd1fd5845f020ebb76', 224, 10);
...
(11, 11, 'بانادول', 'this is med 1', 'حبتان', 'ثلاث مرات', 'لا يجود موانع'),
(12, 15, 'بانادول', 'بانادول', 'حبتان', 'ثلاث مرات', 'لا يجود موانع');
...
(10, 'estb', 'hes', 'user@test.com', '75a2c1a1abd1a7dd1fd5845f020ebb76');
