...
<img style="" id="p_img" src="img\logo_f.png"  ALIGN="center"> <p id="doc_name">&nbsp;&nbsp;Dr. <?php echo $users['fname'];  ?></p>
  ...
  <?php  
     ...
     <input id="med_form"  type="text" name="m_name" value="'.$s['relative_name'].'" placeholder="add name" readonly><br><br>
     <label style="color:#191970;margin-left:2%">Relative Phone :</label><input id="med_form"  type="number" name="m_name" value="'.$s['phone'].'" placeholder="add phone number" readonly>
